...
def move(state: Dict, move: pieces.Move):
    """
...
game_state = move(state=game_state, move=pieces.Move(0, 7, 0, 5, 0))
game_state = move(state=game_state, move=pieces.Move(0, 5, 0, 7, 3, 1))
game_state = move(state=game_state, move=pieces.Move(0, 7, 3, 6, 3, None, "queen"))
